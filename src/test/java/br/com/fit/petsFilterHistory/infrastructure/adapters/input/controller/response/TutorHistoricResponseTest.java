...
class TutorHistoricResponseTest {
	@InjectMocks
	 TutorHistoricResponse tutorHistoricResponseT;
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new TutorHistoricResponse());

		assertThat(TutorHistoricResponse.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
