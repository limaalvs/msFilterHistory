...
class TutorHistoricRequestTest {
	
	@InjectMocks
	TutorHistoricRequest tutorHistoricRequest;
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new TutorHistoricRequest());

		assertThat(TutorHistoricRequest.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
