...
class TutorHistoricEntityTest {

	@InjectMocks
	TutorHistoricEntity tutorHistoricEntity;
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new TutorHistoricEntity());

		assertThat(TutorHistoricEntity.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
