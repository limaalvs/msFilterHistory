...
class AnimalCharacteristicsTest {
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new AnimalCharacteristics());

		assertThat(AnimalCharacteristics.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
