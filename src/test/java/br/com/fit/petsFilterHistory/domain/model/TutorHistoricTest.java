...
class TutorHistoricTest {

	@InjectMocks
	TutorHistoric tutorHistoric;
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new TutorHistoric());

		assertThat(TutorHistoric.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
